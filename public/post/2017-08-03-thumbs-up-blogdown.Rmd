...
So I decided to try it out for myself and write every now and than about my projects and interests. At first I started with the [Beautiful Jekyll](http://deanattali.com/beautiful-jekyll/) theme by [Dean Atalli](http://deanattali.com/) which was very easy to set up thanks to his great documentation. Although i wasn't sure that i understand the underlying technologies (jekyll, ruby...) and what the assumed underlying structure should be - it worked well and i was able to set it up using github pages.  

Then some months ago I found out about [Yihui Xie's](https://yihui.name/) blogdown package and I loved the idea that all of this is made possible from within R itself! [blogdown](https://github.com/rstudio/blogdown) is truly an amazing package and makes the whole process of setting up your own blog, installing themes etc. so easy. It's pretty cool that people like me who don't know much about html, css, javascript and web development - but can work their way around in R can just download a package and set up a personal blog by calling a couple of functions! I think Yihui has contributed pretty amazing stuff to the R world and I really like all of his open-source projects as well as his great ability to use every chance he gets to place somewhere a funny gif :-) (if you don't know about this, you have to check out some of his presentations on useR conference or rstudio::conf 2017 or the xaringan package).  
...
Well, this is more than enough for an initial post. Now that writing blog posts is made a breeze from R - I plan to do this more frequently and on various topics.  

Thanks to the hard work from all the people and organisations that made this possible and easy.  
